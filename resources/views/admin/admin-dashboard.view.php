...
<main class="container mx-auto py-24">
    ...
    <div class="my-10 grid lg:grid-cols-2 lg:grid-rows-2 md:grid-cols-2 md:grid-rows-2 sm:grid-cols-1 sm:grid-rows-1 gap-10">
        <!-- Card 1 -->
        <a class="w-full bg-gray-300 px-4 py-24 rounded-md" href="./?page=admin&type=write">
            <h1 class="text-xl font-bold text-center">Tekst schrijven</h1>
        </a>
        <!-- Card 2 -->
        <a class="w-full bg-gray-300 px-4 py-24 rounded-md" href="./?page=admin&type=users-dashboard">
            <h1 class="text-xl font-bold text-center">Gebruikers rechten</h1>
        </a>
    </div>
</main>